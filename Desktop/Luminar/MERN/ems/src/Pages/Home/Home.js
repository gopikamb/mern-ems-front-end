...
import { addData, updateData,deleteData } from '../../Components/contexts/ContextShare';
...
<div className="second_div">
  {/*table*/}
  {
    showSpin? <div className='d-flex justify-content-center mt-5'><LoadingSpinner/></div>:<Hometable  
